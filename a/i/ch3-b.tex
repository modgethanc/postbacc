...
in the specifics of their language\index{language} and cultural values, but also in how they fit
...
as separate dining areas and options for language\index{language} education.
...
In addition to the negative effects of pushing the Mandarin
language\index{language} onto ethnic
...
within the intellectual class depending on which language\index{language} one used throughout
